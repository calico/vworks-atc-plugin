			...
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Parameters >
						...
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Device to use' Value='Thermo ATC - 1' />
						<Parameter Category='' Name='Location to use' Value='Nest' />
					</Parameters>
				</Task>
				<Task Name='ATC::CLOSE' >
					<Devices >
