...
<Velocity11 file='Protocol_Data' md5sum='4de334a192f54f5ba2b9f3e5f94df0cb' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\Users\tlee.CALICOLABS\source\repos\calico\tlee133\ATC VWorks Plugin\TestData\VWorks Device File\ATC.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='0' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Main_Processes >
			<Process >
				...
				<Task Name='ATC::START' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Protocol File Path' Value='C:\Users\tlee.CALICOLABS\source\repos\calico\tlee133\ATC VWorks Plugin\TestData\ATC Protocols\FifteenCycleTest.xml' />
