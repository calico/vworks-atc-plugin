...
using com.apldbio.pcr.exception;
    ...
    public partial class ATCDialog
    {
        ...
        {
            String instrumentId = dialogModel.DeviceTab.InstrumentId;
            if (null != instrumentId && instrumentId.Length > 0)
            {
                ...
                if (proceed)
                {
                    dialogModel.DeviceTab.LoadingVisibility = Visibility.Visible;
                    IPAddress address;
                    ...
                    {
                        dialogModel.DeviceTab.LoadingVisibility = Visibility.Hidden;
                    });
                }
            }
            else
        ...
        private void ConnectInstrument(string address, ConnectionMode mode)
        {
            ...
            if (ic.Connect(address, mode, new WpfDeviceControlListener(dialogModel.DeviceTab)))
            {
                ...
                Application.Current.Dispatcher.Invoke(() =>
                {
                    ...
                    dialogModel.DeviceTab.UpdateInstrumentProperties(properties, ic.GetAddress());
                    ...
                    if (null != progress)
                    {
                        ...
                        {
                            dialogModel.DeviceTab.UpdateRunProgress(progress.getStage(), progress.getCycle(), progress.getStep());
                        }
                    }
        ...
        private void DisconnectInstrument()
        {
            ...
            Application.Current.Dispatcher.Invoke(() =>
            {
                dialogModel.DeviceTab.ResetInstrumentInfo();
                dialogModel.DeviceTab.ResetTemperature();
                dialogModel.DeviceTab.ResetRunProgress();
            });
        }

        private void DiscoverBtn_Click(object sender, RoutedEventArgs e)
        {
            DiscoverWindow discoverWindow = new DiscoverWindow(dialogModel.DeviceTab);
            discoverWindow.ShowDialog();
        }

        private void RunTimerRadioButton_Checked(object sender, RoutedEventArgs e)
        {
            dialogModel.DeviceTab.UpdateRunTimer();
        }
    }       
}
