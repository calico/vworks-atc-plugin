    ...
    public partial class ATCDialog
    {
        ...
        private void btnImportFile_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    dialogModel.ProtocolTab.ImportProtocol(openFileDialog.FileName);
        ...
        private void btnExportFile_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                dialogModel.ProtocolTab.ValidateProtocol();
                if (SaveProtocolFile())
                {
        ...
        private Boolean SaveProtocolFile()
        {
            ...
            if (!ProtocolFactory.GetDefaultProtocolName().Equals(dialogModel.ProtocolTab.ProtocolModel.Path))
            {
                saveFileDialog.InitialDirectory = dialogModel.ProtocolTab.ProtocolModel.Path;
            }
            if (saveFileDialog.ShowDialog() == true)
            {
                dialogModel.ProtocolTab.ExportProtocol(saveFileDialog.FileName);
                return true;
            }
            return false;
        }
        ...
        private void btnAddStage_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    if (dialogModel.ProtocolTab.AddStageAt(index + 1, item as StageModel))
                    {
                        // Select the new stage
                        ProtocolStages.SelectedItem = dialogModel.ProtocolTab.Stages[index + 1];
                    }
                }
                else
                {
                    ...
                    if (dialogModel.ProtocolTab.Stages.Count > 0)
                    {
                        lastItem = dialogModel.ProtocolTab.Stages.Last<StageModel>();
                    }
                    int index = dialogModel.ProtocolTab.Stages.Count;
                    if (dialogModel.ProtocolTab.AddStageAt(dialogModel.ProtocolTab.Stages.Count, lastItem))
                    {
                        // Select the new stage
                        ProtocolStages.SelectedItem = dialogModel.ProtocolTab.Stages[index];
                    }
                }
        ...
        private void btnDeleteStage_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    if (dialogModel.ProtocolTab.DeleteStageAt(index))
                    {
                        if (index > 0 && dialogModel.ProtocolTab.Stages.Count > 0)
                        {
                            ProtocolStages.SelectedItem = dialogModel.ProtocolTab.Stages[index - 1];
                        }
                        else
                        {
                            ...
                            dialogModel.ProtocolTab.UpdateStageSelection(null);
                        }
                    }
                }
        ...
        private void btnMoveUpStage_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    if (dialogModel.ProtocolTab.MoveStageUp(index))
                    {
                        if (index > 0)
                        {
                            ProtocolStages.SelectedItem = dialogModel.ProtocolTab.Stages[index - 1];
        ...
        private void btnMoveDownStage_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    if (dialogModel.ProtocolTab.MoveStageDown(index))
                    {
                        if (index + 1 < dialogModel.ProtocolTab.Stages.Count)
                        {
                            ProtocolStages.SelectedItem = dialogModel.ProtocolTab.Stages[index + 1];
                        }
                    }
        ...
        private void btnAddStep_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    if (dialogModel.ProtocolTab.AddStepAt(index + 1, item as StepModel))
                    {
                        ProtocolSteps.SelectedItem = dialogModel.ProtocolTab.SelectedStage.Steps[index + 1];
                    }
                }
                else
                {
                    ...
                    if (dialogModel.ProtocolTab.SelectedStage != null)
                    {
                        if (dialogModel.ProtocolTab.SelectedStage.Steps.Count > 0)
                        {
                            lastItem = dialogModel.ProtocolTab.SelectedStage.Steps.Last<StepModel>();
                        }
                        int index = dialogModel.ProtocolTab.SelectedStage.Steps.Count;
                        if (dialogModel.ProtocolTab.AddStepAt(dialogModel.ProtocolTab.SelectedStage.Steps.Count, lastItem))
                        {
                            ProtocolSteps.SelectedItem = dialogModel.ProtocolTab.SelectedStage.Steps[index];
                        }
                    }
        ...
        private void btnDeleteStep_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    if (dialogModel.ProtocolTab.DeleteStepAt(index))
                    {
                        if (index > 0 && dialogModel.ProtocolTab.SelectedStage != null && dialogModel.ProtocolTab.SelectedStage.Steps.Count > 0)
                        {
                            ProtocolSteps.SelectedItem = dialogModel.ProtocolTab.SelectedStage.Steps[index - 1];
                        }
                    }
        ...
        private void btnMoveUpStep_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    if (dialogModel.ProtocolTab.MoveStepUp(index))
                    {
                        if (index > 0 && dialogModel.ProtocolTab.SelectedStage != null)
                        {
                            ProtocolSteps.SelectedItem = dialogModel.ProtocolTab.SelectedStage.Steps[index - 1];
                        }
                    }
        ...
        private void btnMoveDownStep_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    if (dialogModel.ProtocolTab.MoveStepDown(index))
                    {
                        if (dialogModel.ProtocolTab.SelectedStage != null && index + 1 < dialogModel.ProtocolTab.SelectedStage.Steps.Count)
                        {
                            ProtocolSteps.SelectedItem = dialogModel.ProtocolTab.SelectedStage.Steps[index + 1];
                        }
                    }
        ...
        private void protocolStages_Selected(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (item != null && dialogModel.ProtocolTab.SelectedStage != item)
            {
                dialogModel.ProtocolTab.UpdateStageSelection(item as StageModel);
            }
        }
        ...
        private void SetDefaultStageSelection()
        {
            if (dialogModel.ProtocolTab.Stages.Count > 0)
            {
                ProtocolStages.SelectedItem = dialogModel.ProtocolTab.Stages[0];
            }
        }
        ...
        private void btnExportSiLA_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog.ShowDialog() == true)
                {
                    (new SiLAExporter()).SaveToLocal(dialogModel.ProtocolTab.ProtocolModel.Tcprotocol, saveFileDialog.FileName);
        ...
        private void btnClose_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                if (dialogModel.ProtocolTab.IsProtocolModified())
                {
                    String message = String.Format("You have unsaved changes.\nDo you want to save it?",
                        dialogModel.ProtocolTab.ProtocolModel.DisplayName);
